...
const QuoteTable = () => {
  ...
  return (
    <div className="">
      <div className="flex flex-wrap items-center justify-end mb-4 mt-5 gap-4">
        <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto flex-1 sm:flex-initial">
