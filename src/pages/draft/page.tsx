          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="grid gap-4 mb-6">
                {plansLoading ? (
                  ...
                  plans.map((plan) => (
                    <div
                      ...
                      className={`relative p-5 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-lg ${selectedPlanType === plan.key
                ...
                {/* Custom Plan */}
                <div className={`p-5 border-2 rounded-xl transition-all duration-200 ${selectedPlanType === 'custom'
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-shrink-0 pt-6">
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedPlanType === 'custom'
