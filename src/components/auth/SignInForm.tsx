                  ...
                  <div className="mt-2 flex justify-center">
                    <OtpInput
                      ...
                      renderInput={(props) => (
                        <input
                          {...props}
                          className="h-11 w-9 rounded-lg border border-slate-200 bg-slate-50 text-center text-base font-medium text-slate-900 outline-none transition-all focus:border-[#4F46E5] focus:bg-white focus:ring-2 focus:ring-[#4F46E5]/20"
                        />
                      )}
                    />
                  </div>
